...
class AskUseCase:
    def __init__(
        ...
        deepseek_llm_gateway: DeepSeekLLMGateway,
        ...
        self.deepseek_llm_gateway = deepseek_llm_gateway
    ...
    def ask_ai(self, ai_request: AIRequestDomain) -> AIResponseDomain:
        ask_fn = (
            self.deepseek_llm_gateway.ask
            if ai_request.model in ["deepseek-chat", "deepseek-reasoner"]
            else self.google_llm_gateway.ask_with_attachment
